...
export const knowledgeBase: KnowledgeEntry[] = [
  ...
  },
  {
    ...
    strong: ["اسعار", "تكلفه", "كم تاخذون", "بكم", "رسوم", "تكاليف الخدمه", "سعر الخدمه", "سعر الاستشاره", "سعر الجلسه", "كم تكلفه", "كم التكلفه"],
  ...
  },
  {
    id: "contact",
    title: "التواصل",
    strong: ["كيف اتواصل", "تواصل معكم", "واتساب", "واتس", "ايميل", "البريد الالكتروني", "رقم الهاتف", "بيانات التواصل", "اتواصل معكم", "اريد التواصل"],
